...
public final class __advancebooking extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/AdvanceBooking.jsp", 1466370556241L ,"12.1.3.0.0","Africa/Cairo")) return true;
        return false;
    }
    ...
    throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {;
            ...
            out.print(_jsp_expressionInterceptor.intercept( String.valueOf((String)session.getAttribute("userid")), pageContext, weblogic.servlet.jsp.ExpressionInterceptor.Type.Scripting));
