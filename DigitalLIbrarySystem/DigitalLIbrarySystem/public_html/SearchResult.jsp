             ...
             <TR><TD>
                ...
                <tr>
                    <th id="common_th" colspan="${sessionScope.colspan+1}" align="center">
                     ...
                     <!--<tr><td>ReportFor<c:out  value="${param.role} ${param.reportDate} "/></td></tr>-->
                    ...
                    <c:if test="${ ! empty sessionScope.iterate}">
                            <c:choose>
                                                 ...
                                                 <c:set var="start_index" value="${param.start_index}" scope="page"/>
                                                  <c:set var="start_index" value="${param.start_index}" scope="session"/>
                                                 </c:otherwise>
                          </c:choose>
                         <c:choose>
                                                ...
                                                <c:set var="end_index" value="${param.start_index + param.records_per_page -1}" scope="session"/>
                                                  </c:otherwise>
                      </c:choose>
